...
var UserProfileService = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, authId, roleId, userId, data;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.user, authId = _a.id, roleId = _a.roleId;
                ...
                return [4 /*yield*/, repository_1.UserRepository.findByIdWithTask(userId).catch(function (err) {
                        // throw a exception
